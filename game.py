...
class Game:
    ...
    def rotate_bird(self):
        #rotozoom takes into acount the surfaface rotation and zoom
    ...
    def show_score(self, game_state, screen, color):
        ...
        if game_state == "game over":
            ...
            high_score_surface = self.font.render(f"High Score: {str(self.high_score)}",True,color)
